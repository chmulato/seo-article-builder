...
def get_article_config():
    ...
    if CONFIG_AVAILABLE:
        ...
        return {
            ...
            'keywords': 'futuro_programacao, programação, tecnologia, Christian V. Mulato',
...
def validate_environment(config):
    ...
    md_file = Path(config['md_file']) if 'md_file' in config else Path('content/futuro_programacao.md')
...
def main():
    ...
    print("[INFO] Kafka Java Mastery - Futuro da Programação")
    print("=" * 50)
