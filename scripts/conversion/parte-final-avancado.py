...
def get_article_config():
    ...
    if CONFIG_AVAILABLE:
        config = get_config_for_file('parte-final-avancado.md')
        ...
        return {
            ...
            'keywords': 'parte, final, avancado, programação, tecnologia, Christian V. Mulato',
            ...
            'category': 'DevOps',
            'reading_time': '25 min',
            'social_image': 'parte-final-avancado.png',
            'language': 'pt-BR'
        }
...
def main():
    ...
    print("[INFO] Kafka Java Mastery - Parte Final: Produção")
    print("=" * 50)
