...
def main():
    """Converte exemplo_imagens.md para HTML com SEO."""
    
    # Configurações específicas para este artigo
    config = {
        'md_file': 'articles_md/exemplo_imagens.md',
        'html_file': 'output/exemplo_imagens.html',
        'author': 'Christian V. Mulato',
        'url': 'https://christian-mulato.dev',
        'keywords': 'exemplo_imagens, programação, tecnologia',
        'description': 'Artigo sobre Exemplo_Imagens'
    }
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"[WEB] URL: {config['url']}/exemplo_imagens.html")
