...
def get_article_config():
    ...
    if CONFIG_AVAILABLE:
        config = get_config_for_file('parte1-fundamentos.md')
        ...
        return {
            ...
            'keywords': 'parte1, fundamentos, programação, tecnologia, Christian V. Mulato',
            ...
            'reading_time': '15 min',
            'social_image': 'parte1-fundamentos.png',
            'language': 'pt-BR'
        }
...
def main():
    ...
    print("[INFO] Kafka Java Mastery - Parte 1: Fundamentos")
    print("=" * 50)
